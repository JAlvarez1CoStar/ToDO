...
//  Todo
//
//  Created by Jose Alvarez on 8/3/17.
...
class APIClientTests: XCTestCase {
    ...
    func test_Login_UsesExpectedURL() {
        ...
        sut.loginUser(withName: "dasdøm", password: "%&34", completion: completion)
        ...
        guard let expectedUsername = "dasdøm".addingPercentEncoding(withAllowedCharacters: allowedCharacters) else {
            fatalError()
        }
